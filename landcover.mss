...
@grass: darken(@land-color, 5%);      // Lch(90,32,128) also grassland, meadow, village_green, garden, allotments
@scrub: darken(@land-color, 5%);        // Lch(84,24,122)
@allotments: darken(@land-color, 5%);   // Lch(87,20,135)

@forest: #C8E6C9;       // Lch(80,30,135)#BAF9BE
@park: #C3ECB5;         // Lch(94,30,145)C5E1A5


@orchard: #def6c0; // also vineyard, plant_nursery


// --- "Base" landuses ---

@built-up-lowzoom: @land-color;
@built-up-z11: @land-color;
@built-up-z12: @land-color;
...
@farmland: @grass;         // Lch(94,14,112)
@farmland-line: darken(@grass, 1%);    // Lch(80,14,112)
@farmyard: darken(@grass, 2%);         // Lch(89,20,80)
@farmyard-line: darken(@grass, 3%);    // Lch(75,25,80)
...
@cemetery: darken(@grass, 5%); // also grave_yard
