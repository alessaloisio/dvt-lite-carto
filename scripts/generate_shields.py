...
def main():
    ...
    config['motorway']['fill'] = '#2ecc71'
    config['motorway']['stroke_fill'] = '#2bbf6a'

    config['trunk']['fill'] = '#e74c3c'
    config['trunk']['stroke_fill'] = '#d94738'

    config['primary']['fill'] = '#f1c40f'
    config['primary']['stroke_fill'] = '#e6bb0e'

    config['secondary']['fill'] = '#3498db'
    config['secondary']['stroke_fill'] = '#318fcf'
